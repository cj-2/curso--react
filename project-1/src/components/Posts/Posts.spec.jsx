...
/**
 * Como já existem testes para "PostCard", apenas é necessário
 * testar quantos foram renderizados, e não o conteúdo deles.
 */
...
describe("<Posts />", () => {
    ...
    it("should not render posts", () => {
        ...
        ).toHaveLength(0); // query busca sem disparar erro caso não encontre nada
    });
